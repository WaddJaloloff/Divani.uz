        ...
        var e = a("html, body"),
            ...
            h = {
                ...
                shouldLoadAnchor: function(a, b, c) {
                    var e = a.prop("href");
                    return !(h.isExternal(e) || h.isHash(e) || a.is(b) || a.prop("target") || typeof c !== d && "" !== c && a.prop("href").search(c) === -1)
                },
            ...
            j = function(g, i) {
                var j = a(g),
                    ...
                    t = function(d) {
                        ...
                        h.length ? (c.title = n[d].title, j.data("smoothState").href = d, i.loadingClass && e.removeClass(i.loadingClass), i.onReady.render(j, h), j.one("ss.onReadyEnd", function() {
                            m = !1, i.onAfter(j, h), i.scroll && s(), B(j)
                    ...
                    B = function(a) {
                        i.anchors && i.prefetch && a.find(i.anchors).not(i.prefetchBlacklist).on(i.prefetchOn, null, v)
                    },
                    C = function(a) {
                        i.anchors && (a.on("click", i.anchors, w), B(a)), i.forms && a.on("submit", i.forms, x)
                    },
                    D = function() {
                        var a = j.prop("class");
                ...
                return i = a.extend({}, a.fn.smoothState.options, i), null === b.history.state ? (o = i.alterChangeState({
                    id: k
                }, c.title, p), b.history.replaceState(o, c.title, p)) : o = {}, h.storePageIn(n, p, c.documentElement.outerHTML, k, o), h.triggerAllAnimationEndEvent(j, "ss.onStartEnd ss.onProgressEnd ss.onEndEnd"), C(j), {
                    href: p,
                    cache: n,
                    clear: q,
                    load: u,
...
! function(e) {
    var t, n = /<(\/?)(html|head|body|title|base|meta)(\s+[^>]*)?>/gi,
        a = "hd" + +new Date;
    e.htmlDoc = function(r) {
        var i = e(),
            c = r.replace(n, function(t, n, r, c) {
                var d = {};
                return n || (i = i.add("<" + r + "/>"), c && e.each(e("<div" + c + "/>")[0].attributes, function(e, t) {
                    d[t.name] = t.value
                }), i.eq(-1).attr(d)), "<" + n + "div" + (n ? "" : ' id="' + a + (i.length - 1) + '"') + ">"
            });
        return i.length ? (t || (t = e("<div/>")), t.html(c), e.each(i, function(e) {
            var n = t.find("#" + a + e).before(i[e]);
            i.eq(e).html(n.contents()), n.remove()
        }), t.children().unwrap()) : e(r)
    }
}(jQuery);
/*!
 * smoothState.js is jQuery plugin that progressively enhances
